...
export class Board {
    ...
    createBoard(){
        ...
        newBoard.push(new PropertySquare(9, sq9, [], 'goblinsProp3', 60, 10, 'goblins', false, null, false))

        const sq10 = document.getElementById('sq-10')
        newBoard.push(new DungeonSquare(10, sq10, [], [], []))

        const sq11 = document.getElementById('sq-11')
        newBoard.push(new PropertySquare(11, sq11, [], 'orcsProp1', 70, 10, 'orcs', false, null, false))

        const sq12 = document.getElementById('sq-12')
        newBoard.push(new CastleSquare(12, sq12, []))

        const sq13 = document.getElementById('sq-13')
        newBoard.push(new PropertySquare(13, sq13, [], 'orcsProp2', 70, 10, 'orcs', false, null, false))

        const sq14 = document.getElementById('sq-14')
        newBoard.push(new PropertySquare(14, sq14, [], 'orcsProp3', 80, 15, 'orcs', false, null, false))
        ...
        newBoard.push(new PropertySquare(19, sq19, [], 'fishmenProp3', 100, 20, 'fishmen', false, null, false))
        ...
        newBoard.push(new PropertySquare(24, sq24, [], 'dwarvesProp3', 120, 25, 'dwarves', false, null, false))
        ...
        newBoard.push(new PropertySquare(31, sq31, [], 'gnomesProp1', 150, 30, 'gnomes', false, null, false))
        ...
        newBoard.push(new PropertySquare(39, sq39, [], 'demonsProp2', 200, 50, 'demons', false, null, false))
