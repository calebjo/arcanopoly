...
export class Board {
    ...
    createBoard(){
        ...
        newBoard.push(new PropertySquare(1, sq1, [], 'humansProp1', 30, 'humans', false, null, false))

        const sq2 = document.getElementById('sq-2')
        newBoard.push(new DeckSquare(2, sq2, [], 'sun'))

        const sq3 = document.getElementById('sq-3')
        newBoard.push(new PropertySquare(3, sq3, [], 'humansProp2', 30, 'humans', false, null, false))
        ...
        newBoard.push(new PropertySquare(23, sq23, [], 'dwarvesProp2', 110, 'dwarves', false, null, false))

        const sq24 = document.getElementById('sq-24')
        newBoard.push(new PropertySquare(24, sq24, [], 'dwarvesProp3', 120, 'dwarves', false, null, false))

        const sq25 = document.getElementById('sq-25')
        newBoard.push(new ShopSquare(25, sq25, []))

        const sq26 = document.getElementById('sq-26')
        newBoard.push(new PropertySquare(26, sq26, [], 'undeadProp1', 130, 'undead', false, null, false))

        const sq27 = document.getElementById('sq-27')
        newBoard.push(new PropertySquare(27, sq27, [], 'undeadProp2', 130, 'undead', false, null, false))

        const sq28 = document.getElementById('sq-28')
        newBoard.push(new CastleSquare(28, sq28, []))

        const sq29 = document.getElementById('sq-29')
        newBoard.push(new PropertySquare(29, sq29, [], 'undeadProp3', 140, 'undead', false, null, false))
        ...
        newBoard.push(new PropertySquare(31, sq31, [], 'gnomesProp1', 150, 'gnomes', false, null, false))

        const sq32 = document.getElementById('sq-32')
        newBoard.push(new PropertySquare(32, sq32, [], 'gnomesProp2', 150, 'gnomes', false, null, false))

        const sq33 = document.getElementById('sq-33')
        newBoard.push(new DeckSquare(33, sq33, [], 'sun'))

        const sq34 = document.getElementById('sq-34')
        newBoard.push(new PropertySquare(34, sq34, [], 'gnomesProp3', 160, 'gnomes', false, null, false))
        ...
        newBoard.push(new PropertySquare(37, sq37, [], 'demonsProp1', 175, 'demons', false, null, false))
        ...
        newBoard.push(new PropertySquare(39, sq39, [], 'demonsProp2', 200, 'demons', false, null, false))
