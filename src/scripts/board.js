...
export class Board {
    ...
    createBoard(){
        ...
        newBoard.push(new PropertySquare(1, sq1, [], 'Lakeside', 30, 5, 'Human', false, null, false))

        const sq2 = document.getElementById('sq-2')
        newBoard.push(new DeckSquare(2, sq2, [], 'sun', null))

        const sq3 = document.getElementById('sq-3')
        newBoard.push(new PropertySquare(3, sq3, [], 'Cliffhill', 30, 5, 'Human', false, null, false))
        ...
        newBoard.push(new PropertySquare(18, sq18, [], 'Expari', 90, 15, 'Fishman', false, null, false))

        const sq19 = document.getElementById('sq-19')
        newBoard.push(new PropertySquare(19, sq19, [], 'Navalean', 100, 20, 'Fishman', false, null, false))

        const sq20 = document.getElementById('sq-20')
        newBoard.push(new TomeSquare(20, sq20, []))

        const sq21 = document.getElementById('sq-21')
        newBoard.push(new PropertySquare(21, sq21, [], 'Hamborimm', 110, 20, 'Dwarf', false, null, false))
        ...
        newBoard.push(new PropertySquare(23, sq23, [], 'Bhog Kul', 110, 20, 'Dwarf', false, null, false))

        const sq24 = document.getElementById('sq-24')
        newBoard.push(new PropertySquare(24, sq24, [], 'Dhorn Todur', 120, 25, 'Dwarf', false, null, false))

        const sq25 = document.getElementById('sq-25')
        newBoard.push(new ShopSquare(25, sq25, []))

        const sq26 = document.getElementById('sq-26')
        newBoard.push(new PropertySquare(26, sq26, [], 'Khoss', 130, 25, 'Undead', false, null, false))

        const sq27 = document.getElementById('sq-27')
        newBoard.push(new PropertySquare(27, sq27, [], 'Aor Jaggur', 130, 25, 'Undead', false, null, false))

        const sq28 = document.getElementById('sq-28')
        newBoard.push(new CastleSquare(28, sq28, []))

        const sq29 = document.getElementById('sq-29')
        newBoard.push(new PropertySquare(29, sq29, [], 'Jolzor', 140, 30, 'Undead', false, null, false))
        ...
        newBoard.push(new PropertySquare(31, sq31, [], 'Cogstead', 150, 30, 'Gnome', false, null, false))

        const sq32 = document.getElementById('sq-32')
        newBoard.push(new PropertySquare(32, sq32, [], 'Dazzlefort', 150, 30, 'Gnome', false, null, false))
        ...
        newBoard.push(new PropertySquare(34, sq34, [], 'Aetherward', 160, 35, 'Gnome', false, null, false))
        ...
        newBoard.push(new PropertySquare(37, sq37, [], 'Attarax', 175, 40, 'Demon', false, null, false))
        ...
        newBoard.push(new PropertySquare(39, sq39, [], 'Flamebridge', 200, 50, 'Demon', false, null, false))
