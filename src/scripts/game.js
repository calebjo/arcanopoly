...
export class Game {
    ...
    playTurn(){
        ...
        this.preRollTurn();
        console.log(`currentPlayer before call is: ${this.currentPlayer}`)
        console.log('End of playTurn()') // TEST
    }
    ...
    preRollTurn(){
        ...
        this.mainButton.addEventListener("click", this.handleDiceRoll);
        ...
        this.mainButton.children[0].innerText  = 'End';
    ...
    handleDiceRoll(){
        ...
        console.log(`currentPlayer's diceNum is: ${this.currentPlayer.diceNum}`)
